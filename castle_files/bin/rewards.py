...
def smuggler(bot, update):
    ...
    bot.send_message(chat_id=mes.chat_id,
                     text="Вы подходите к контробандисту. *Место для охуенного описания от Джеди.*\n\n"
                          ...
                          "7) Операция \"Козел в огороде\" - найм банды отпетых отморозков и негодяев для "
                          ...
                          "8) Спецоперация \"Прачка в прачечной\". Лучшие спецы розыска займутся подчищением следов"
