...
central_square = Location(0, "⛲️ Центральная площадь",
                          ...
                          "Коротка выдержка из местной газеты перекрывает объявление.\n"
                          "Из-под клочка пергамента видна подпись и печать Короля."
...
roulette = Location(10, "🎰Рулетка", "Рулетка. Здесь ты можешь посоревноваться с другими игроками в удаче."
                    "Игры проходят каждые полчаса с 9 до 21 часа по МСК", special_info={})
