texts_translate = {
    ...
    "В дальнем темном углу вы видите мужчину. Своеобразная эмблема Черного Рынка выдает в нем "
    ...
    "действенное средство. Забыть ее светящиеся крылья ты не сможешь никогда, а вот сменить"
    ...
    "Коррумпированные чиновники - бич любого государства. Но это и большие возможности. "
    ...
    "/castle_ro\n\n":
        "In the far dark corner you see a man. A peculiar emblem of the Black Market gives it a connection with the "
        "criminal layers of the Castle.\n "
        "- \"Well, you're a cormorant, if th on business is, or get out of here on, while the olive is not caught. In "
        "the zyr only Birr-Birr, a horn.\"\n\n "
        ...
        "/castle_request_pin\n\n"
        "5) Operation \"Goat in the garden\" - hiring a gang of inveterate thugs and scoundrels for a senseless "
        "burglary. "
