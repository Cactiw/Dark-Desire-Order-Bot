...
texts_translate = {
    "Вы входите в Мандапу Славы - почетное место, где увековечены герои Скалы, их подвиги и заслуги перед замком. На стене развешены лучшие из лучших.\n\nВыберите категорию:":
        "You are entering the Hall of Fame - an honorable place where the heroes of the Rock, their exploits and services to the castle are immortalized. There are best of the best on the wall.\n\nSelect a category:",
    ...
    "Вы поднимаетесь в Тронный Зал. Здесь можно обратиться к Высшему Командному Составу Скалы и даже попросить аудиенции у 👑":
        "You go upstairs to the Throne Room. Here you can contact the Highest Command Of the Rock and even ask for an audience with the 👑",
    "Вы подошли к вратам замка. Здесь как всегда немноголюдно. На посту дежурят стражи Скалы, возможно, они смогут подсказать дорогу до нужного места, поделиться новостями или просто с радостью скоротают время в беседе.":
        "You have come to the castle gate. it’s always not crowded here. There are Rock guards on duty, perhaps they will be able to tell the way to the right place, to share the news or just happy to spend the time in conversation.",
    ...
    "Вы отправились добывать дерево. Это займёт примерно 3 минуты.\n\n"
        "Вы можете вернуться мгновенно. В этом случае вся добыча будет утеряна.": "You went to get the wood. It will take about 3 minutes.\n\n"
        "You can come back instantly. In this case, all production will be lost.",
    ...
    "Удалить заместителя - /del_assistant - аналогично, реплаем на сообщение игрока, которого необходимо снять с должности заместителя":
    ...
    "Вы не состоите в гильдии. Вступите в гильдию в игре и попросите командира добавить вас в гильдейском чате.":
        "You are not a member of the Guild. Join a Guild in the game and ask the commander to add you to the Guild chat.",
    ...
    "⛩<b>Castle gates</b> - you can always have a word with the local guards here, they are bored on duty anyway.\n\n"
    "🏛<b>Throne Room</b> - a place where you can learn the news, ask the generals any question and even request an audience with the King.\n\n"
    "🔭<b>TechMag Science Tower</b> - the basis of the order of Dark Desire. Here, bit by bit, the reviews "
    "of techno-magical artifacts are gathering. In this place you can also find the news about the work of the order on the improvement of techno-magic rock fixtures.\n\n"
    "🏤<b>Hall of Fame</b> - pride of place, where the heroes of the Rock, their exploits and services to the castle "
    ...
    "Чайная лига. Здесь ты сможешь узнать новости замка, получить работенку, заработать деньжат и , вероятно, заслужить славу и уважение." :
