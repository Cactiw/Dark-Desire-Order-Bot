...
class FilterIsTrigger(BaseFilter):
    def filter(self, message):
        ...
        print(local_triggers is not None and message.text.lower() in local_triggers, message.text.lower() in global_triggers_in, (local_triggers is not None and message.text.lower() in local_triggers) or \
