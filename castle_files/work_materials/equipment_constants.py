...
main_hand = [
    ...
    Equipment("main_hand", "e", "151", "🧟‍♂️Demon Bow", 26, 12, 2),
...
second_hand = [
    ...
    Equipment("second_hand", "e", "152", "🧟‍♂️Demon Whip", 15, 1, 2),
...
gloves = [
    ...
    Equipment("gloves", "a", "30", "Order Gauntlets", 2, 10, 2),
    Equipment("gloves", "a", "39", "Clarity Bracers", 1, 9, 2),
    Equipment("gloves", "a", "35", "Hunter Gloves", 3, 8, 2),
    ...
    Equipment("gloves", "a", "109", "Manticore Gloves", 11, 15, 5),
    Equipment("gloves", "a", "110", "Overseer Gauntlets", 6, 19, 5),
    Equipment("gloves", "a", "111", "Discarnate Bracers", 7, 15, 5),
    ...
    Equipment("gloves", "e", "126", "🧟‍♂️Demon Bracers", 5, 7, 2),
...
armor = [
    ...
    Equipment("armor", "a", "103", "Manticore Armor", 24, 45, 5),
    Equipment("armor", "a", "104", "Overseer Armor", 18, 60, 5),
    Equipment("armor", "a", "105", "Discarnate Robe", 19, 45, 5),
    ...
    Equipment("armor", "e", "123", "🧟‍♂️Demon Robe", 10, 22, 2),
...
boots = [
    ...
    Equipment("boots", "a", "114", "Manticore Boots", 12, 15, 5),
    Equipment("boots", "a", "115", "Overseer Boots", 6, 20, 5),
    Equipment("boots", "a", "116", "Discarnate Shoes", 7, 14, 5),
    ...
    Equipment("boots", "e", "125", "🧟‍♂️Demon Shoes", 5, 7, 2),
